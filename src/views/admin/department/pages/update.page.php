...
<main class="p-4 md:ml-64 h-auto pt-20 overflow-hidden">
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            <form action="/department/update?id=<?= $UID ?>" method="POST">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="w-full mb-4">
                        ...
                        <input type="text" name="NAME" id="NAME"
                            ...
                            placeholder="Enter your Department name" required="" value="<?= $details["NAME"] ?>" />
                    </div>
                    ...
                    <div class="w-full">
                        ...
                        <input type="color" name="COLOR" id="COLOR"
                            ...
                            placeholder="Enter your last name" required="" value="<?= $details["COLOR"] ?>" />
                    </div>
                </div>
                <button type="submit"
