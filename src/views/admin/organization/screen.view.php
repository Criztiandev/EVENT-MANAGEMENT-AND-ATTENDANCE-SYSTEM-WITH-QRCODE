    ...
    <section class="">
        <div class="flex justify-end items-center my-4">
            <div
                ...
                <a href="/organization/create" type="button"
                ...
                <a href="/organization/position/create" type="button"
                    class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                    <svg class="h-3.5 w-3.5 mr-2" fill="currentColor" viewbox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        <path clip-rule="evenodd" fill-rule="evenodd"
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="w-full md:w-1/2">
                            ...
                            <h2 class="font-bold text-xl">Organization list</h2>
                        </div>

                    </div>
                    <div class="overflow-x-auto" style="height: calc(100vh - 300px);">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <?php foreach ($organization_list as $items): ?>
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class=" flex justify-center items-center">
                                            ...
                                            <a href="/organization/update?id=<?= $items["ID"] ?>" type="button"
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="w-full md:w-1/2">
                            ...
                            <h2 class="font-bold text-xl">Position List</h2>
                        </div>
                    ...
                    <div class="overflow-x-auto" style="height: calc(100vh - 300px);">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <?php foreach ($position_list as $items): ?>
                                    <tr class="border-b dark:border-gray-700">
                                        <th scope="row"
                                            class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <?= $items["NAME"] ?>
                                        ...
                                        <td class=" flex justify-center items-center">
                                            ...
                                            <a href="/organization/position/update?id=<?= $items["ID"] ?>" type="button"
                                                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                                <svg xmlns='http://www.w3.org/2000/svg' width='18' height='18'
                                                    viewBox='0 0 24 24'>
                                                    <title>edit_2_fill</title>
